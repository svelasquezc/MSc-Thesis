...
En el BOM se establece, también, que los fluidos tienen una compresibilidad, es decir que cambian su volumen según la presión a la que se someten. La propiedad que se asocia a ese cambio de volumen es el factor volumétrico ($B_{f}$).
...
\begin{figure}[h]
	...
	\caption[Elementos del EP.]{Elementos del EP (Cambiar atributo compuesto por concepto clase). Tomado de \citep{zapata2012unc}.} \label{fig:InitialPS}
\end{figure}
