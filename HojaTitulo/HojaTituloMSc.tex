...
Un modelo ejecutable para la simulación multi-f\'{\i}sica de procesos de recobro mejorado en yacimientos de petr\'{o}leo basado en esquemas preconceptuales}\\[6.0cm]
\Large\textbf{Steven Velásquez Chancí}\\[6.0cm]
...
t\'{\i}tulo de:\\
\textbf{Magister en Ingenier\'{\i}a de Sistemas}\\[2.0cm]
Director:\\
...
Dinámicas de Flujo y Transporte en medios porosos\\[2.5cm]
...
Agradecimientos eternos eternos eternos a Paola Andrea Nore\~{n}a Cardona, por su constante fé, apoyo y asesoría durante el desarrollo de esta tesis, sin ella esto no sería posible.
